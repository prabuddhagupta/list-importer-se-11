 ...
 *       &lt;sequence>
 *         &lt;element ref="{}EntityNames" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "EntityNameDetails")
public class EntityNameDetails {

    @XmlElement(name = "EntityNames", required = true)
    protected List<EntityNames> entityNames;
     ...
     * 
     */
    public List<EntityNames> getEntityNames() {
        if (entityNames == null) {
