 ...
 *       &lt;sequence>
 *         &lt;element ref="{}Subsidiary" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SubsidiaryList")
public class SubsidiaryList {

    @XmlElement(name = "Subsidiary", required = true)
    protected List<Subsidiary> subsidiary;
    ...
    public List<Subsidiary> getSubsidiary() {
        if (subsidiary == null) {
            subsidiary = new ArrayList<Subsidiary>();
        }
