 ...
 *       &lt;sequence>
 *         &lt;element ref="{}BirthPlace" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "BirthPlaceDetails")
public class BirthPlaceDetails {

    @XmlElement(name = "BirthPlace")
    protected List<BirthPlace> birthPlace;
    ...
    public List<BirthPlace> getBirthPlace() {
        if (birthPlace == null) {
            birthPlace = new ArrayList<BirthPlace>();
        }
