    ...
    public void setProxy(String proxyIp, int proxyPort, Proxy.Type proxyType) {
        if (proxyType.equals(Proxy.Type.HTTP)) {
            ...
            httpClient
                ...
                .getSchemeRegistry()
                .register(
                    new Scheme("http", 80, new MySSLSocketFactory.MySchemeSocketFactory()));
        }
    }
                ...
                while (count < retryCount) {
                    try {
                        ...
                        if (count + 1 < retryCount) {
                            System.out.println("Retrying: " + httpUrl);
                        }
                    }
                    // updateCookies();
                    count++;
...
class MySSLSocketFactory extends SSLSocketFactory {
    ...
    MySSLSocketFactory() throws NoSuchAlgorithmException,
