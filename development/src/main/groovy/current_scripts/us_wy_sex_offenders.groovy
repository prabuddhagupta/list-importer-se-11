...
baseUrl = "http://kspsor.state.ky.us/"
...
if (stateAbbreviation.equals("KY")) {
    ...
    indexUrl = "http://kspsor.state.ky.us/Home/QuickSearch";
    ...
    indexUrl = baseUrl + "Home/QuickSearch ";
} else
    context.setup([socketTimeout: 30000, connectionTimeout: 10000, retryCount: 5, multithread: true]);
...
def handleIndexPage(indexUrl) {
    ...
    if (stateAbbreviation.equals("KY")) {
        ...
        indexPage = context.invoke([url: baseUrl+"Home/QuickSearch", tidy: true, cache: false]);
    }
